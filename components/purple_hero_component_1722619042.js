...
Vue.component("purple_hero_component_1722619042", {
    template: `
    <section id="hero-section-container" class="bg-gradient-to-br from-pink-500 via-purple-600 to-black min-h-screen flex items-center justify-center">
    <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl">
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                <div id="announcement-text" class="mb-6" data-aos="fade-down">
                    <div id="announcement-text-inner" class="flex relative before:absolute before:inset-0 before:blur-md before:bg-pink-500/30">
                        <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-white hover:text-pink-200" 
                           href="#0" 
                           style="background: linear-gradient(rgba(255,255,255,0.1), rgba(255,255,255,0.2)) padding-box, linear-gradient(to right, rgba(255,105,180,0.5), rgba(138,43,226,0.5)) border-box;">
                            <span id="announcement-link-text" class="relative inline-flex items-center">
                                Introducing our new Blockchain Intelligence Suite 
                ...
                <div class="flex" id="hero-text-container">
                    <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-300 pb-4 text-5xl font-extrabold" data-aos="fade-down">Real-time Blockchain Data Analysis</h1>
                </div>
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-white/80" data-aos="fade-down" data-aos-delay="200">Gain powerful insights from the latest blockchain activity with our advanced analytics tools.</p>
                </div>
                <div id="buttons-container" class="flex justify-center space-x-4 mt-8">
                    <div id="get-started-button-container">
                        <a id="get-started-button" 
                           class="flex items-center justify-center px-6 py-3 text-white bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg shadow-lg transition duration-150 ease-in-out hover:from-pink-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50" 
                           href="#0">
                            Get Started 
                    ...
                    <div id="docs-button-container">
                        <a id="docs-button" class="flex items-center justify-center px-6 py-3 text-white bg-white/20 backdrop-blur-md rounded-lg shadow-lg transition duration-150 ease-in-out hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50" href="#0">
